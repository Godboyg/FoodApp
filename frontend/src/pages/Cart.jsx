    ...
    <div className="p-6 h-screen relative">
        ...
        <div className="px-8 py-5 text-white">
          ...
          {cartItems.length === 0 ? (
           ...
           <div 
           className="absolute bottom-10 max-sm:bottom-20 max-sm:left-0 rounded-md font-bold text-2xl bg-green-500 p-3 hover:cursor-pointer max-sm:w-84 max-sm:text-center"
           onClick={handleOrder}
           >
             Place Order
           </div>
